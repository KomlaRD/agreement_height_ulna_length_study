...
blandr.statistics (df$predicted_height_must, df$mean_height , sig.level=0.95 )
```
...
#| message: false
#| warning: false
blandr.draw( df$predicted_height_must , df$mean_height )
```
...
blandr.statistics (df$predicted_height_madden, df$mean_height , sig.level=0.95 )
```
...
#| message: false
#| warning: false
blandr.draw( df$predicted_height_madden , df$mean_height )
```
