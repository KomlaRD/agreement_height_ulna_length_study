...
# Bar chart for occupation (Cleaning: Find unique values and recode categories)
df |>
  ggplot(aes(occupation)) +
  geom_bar()

# Bar chart for ethnicity (cleaning: add Akan:Fante and Fante to Akan)
df |>
  ggplot(aes(ethnicity)) +
  geom_bar()

# Bar chart for religion (Cleaning: merge christian and christianity, islam and islamic)
df |>
  ggplot(aes(religion)) +
  geom_bar()
```
